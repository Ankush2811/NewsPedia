...
function Footer() {
        ...
        <div className="footer-icons">
            <ul className="navbar-nav ">
                <li className="nav-item inline-block">
                    <a href="https://github.com/Ankush2811" aria-label="Github" className="nav-link text-github"><i
                            className="fa fa-github"></i></a></li>
                <li className="nav-item inline-block">
                    <a href="https://medium.com/@ankush2811" aria-label="Medium" className="nav-link">
    ...
    <h5  className="text-center copyright"> © Copyrights reserved by Ankush Soni</h5>
        </>
    )
}
